...
To contribute with your own replays download and install [dsstats.maui](https://github.com/ipax77/dsstats/releases/latest) ([Installing the app](https://learn.microsoft.com/en-us/dotnet/maui/windows/deployment/publish-cli#installing-the-app))
...
[DsStats Website](https://dsstats.pax77.org)