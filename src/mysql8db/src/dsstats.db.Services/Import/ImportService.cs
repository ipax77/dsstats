...
public partial class ImportService : IImportService
{
    ...
    readonly SemaphoreSlim unitsSs = new(1, 1);
    readonly SemaphoreSlim upgradesSs = new(1, 1);
    readonly SemaphoreSlim playersSs = new(1, 1);
    readonly SemaphoreSlim initSs = new(1, 1);
