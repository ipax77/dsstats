...
public partial class RatingsSaveService
{
    ...
    public async Task SaveComboPlayerRatings(Dictionary<int, Dictionary<PlayerId, CalcRating>> mmrIdRatings)
    {
        ...
        await WirteComboPlayerRatingsCsvFile(mmrIdRatings, playerIds, options.Value.ImportConnectionString);
    }
                                                ...
                                                string connectionString)
    {
        ...
        foreach (var ent in mmrIdRatings)
        {
            foreach (var entCalc in ent.Value.Values)
            {
                ...
                ratings.Add(GetComboPlayerRatingCsvLine(entCalc, ent.Key, i, playerId));
