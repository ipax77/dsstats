...
public partial class MmrProduceService
{
                                         ...
                                         DateTime endTime = default)
    {
        ...
        while (_startTime < _endTime)
        {
            ...
            var result = await ratingRepository.UpdatePlayerRatings<PlayerRatingCmdr>(MmrService.GetPlayerRatings(players.ToList(), mmrIdRatigns));
        }
    }
    ...
    public async Task ProduceStdRatings(Dictionary<CmdrMmmrKey, CmdrMmmrValue> cmdrMmrDic, double maxMmr, DateTime startTime = default, DateTime endTime = default)
    {
        ...
        while (_startTime < endTime)
        {
            ...
            var result = await ratingRepository.UpdatePlayerRatings<PlayerRatingStd>(MmrService.GetPlayerRatings(players.ToList(), mmrIdRatigns));
        }
    }
