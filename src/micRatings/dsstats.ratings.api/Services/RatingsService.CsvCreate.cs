...
public partial class RatingsService
{
    ...
    public (int, int) CreateOrAppendReplayAndReplayPlayerRatingsCsv(List<ReplayRatingDto> replayRatingDtos, int replayAppendId, int replayPlayerAppendId, string csvBasePath)
    {
