...
public static partial class UnitMap
{
    ...
    private static readonly FrozenDictionary<string, UnitInfo> _unitInfoMap = new Dictionary<string, UnitInfo>()
    {
        ...
        { "A.R.E.S.", new("ARES", UnitSize.Medium, UnitType.Ground) },
        ...
        { "Elite Marine", new("EliteMarine", UnitSize.Small, UnitType.Ground) },
        { "EliteMarine", new("EliteMarine", UnitSize.Small, UnitType.Ground) },
        ...
        { "Flyer", new("Flyer", UnitSize.Medium, UnitType.Air) },
        ...
        { "GhostNova", new("GhostNova", UnitSize.Small, UnitType.Ground) },
        ...
        { "HybridBehemoth", new("HybridBehemoth", UnitSize.VeryLarge, UnitType.Ground) },
        { "HybridDestroyer", new("HybridDestroyer", UnitSize.VeryLarge, UnitType.Ground) },
        { "HybridDominator", new("HybridDominator", UnitSize.VeryLarge, UnitType.Ground) },
        { "HybridNemesis", new("HybridNemesis", UnitSize.VeryLarge, UnitType.Ground) },
        { "HybridReaver", new("HybridReaver", UnitSize.VeryLarge, UnitType.Ground) },
        ...
        { "MarauderCommando", new("MarauderCommando", UnitSize.Medium, UnitType.Ground) },
        ...
        { "RaidLiberator", new("RaidLiberator", UnitSize.Medium, UnitType.Air) },
